...
class RunningCounterHomeState extends State<RunningCounterHome>
  ...
  Future<void> fetchGoals() async {
    try {
      final querySnapshot =
          await FirebaseFirestore.instance.collection('runningGoals').get();
      ...
      setState(() {
        runningGoals = []; // Set an empty list to avoid infinite spinner
      });
    }
  }
